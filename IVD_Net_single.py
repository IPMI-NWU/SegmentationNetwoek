...
class IVD_Net_asym(nn.Module):
    ...
    def __init__(self, input_nc, output_nc, ngf):
        ...
        self.down_3_0 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 6, self.out_dim * 4, act_fn)
        self.pool_3_0 = maxpool()
        self.down_4_0 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 14, self.out_dim * 8, act_fn)
        ...
        self.down_3_1 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 6, self.out_dim * 4, act_fn)
        self.pool_3_1 = maxpool()
        self.down_4_1 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 14, self.out_dim * 8, act_fn)
        ...
        self.down_2_2 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 2, self.out_dim * 2, act_fn)
        self.pool_2_2 = maxpool()
        self.down_3_2 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 6, self.out_dim * 4, act_fn)
        self.pool_3_2 = maxpool()
        self.down_4_2 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 14, self.out_dim * 8, act_fn)
        ...
        self.down_2_3 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 2, self.out_dim * 2, act_fn)
        self.pool_2_3 = maxpool()
        self.down_3_3 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 6, self.out_dim * 4, act_fn)
        self.pool_3_3 = maxpool()
        self.down_4_3 = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 14, self.out_dim * 8, act_fn)
        self.pool_4_3 = maxpool()

        # Bridge between Encoder-Decoder
        self.bridge = Conv_residual_conv_Inception_Dilation_asymmetric(self.out_dim * 30, self.out_dim * 16, act_fn)
...
if __name__ == "__main__":
    ...
    print('model_summary', summary(net, input_size=(2, 64, 64), batch_size=2, device='cpu'))
    print("ok!")

    # net = LSTM_MMUnet(1, num_classes, ngf=ngf, temporal=3)
    # print("total parameter:" + str(netSize(net)))   # 2860,3315
    MRI = torch.randn(2, 2, 64, 64)  # bz * temporal * modal * W * H
