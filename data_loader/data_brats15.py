...
if __name__ == "__main__":
    ...
    image2d, label2d, im_name = brats15[60]
    # print('image2d.shape', image2d.shape)  # torch.Size([4, 240, 240])
    # print('label2d.shape', label2d.shape)  # torch.Size([240, 240])
    # print('name', im_name)  # ../data_sample/HGG/brats_2013_pat0001_1=slice70
