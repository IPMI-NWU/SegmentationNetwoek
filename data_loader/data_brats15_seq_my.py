...
class Brats15DataLoader(Dataset):
    ...
    def get_subject(subject):
        ...
        """
        # **************** get file ****************
        files = os.listdir(subject)  # ['100', '97', '98', '99']
        multi_mode_dir = []
        label_dir = ""
        for f in files:
        ...
        for mod_dir in multi_mode_dir:
            ...
            pic_name1_1 = mod_dir + "_3.png"
            pic_name1_2 = mod_dir + "_4.png"  # 最核心
            pic_name1_3 = mod_dir + "_5.png"
            pic_name2 = "DWI_" + mod_dir + ".png"
            label_name = "mask_" + mod_dir + ".png"
            img1_1 = Image.open(os.path.join(path, pic_name1_1)).convert('L')
            img1_2 = Image.open(os.path.join(path, pic_name1_2)).convert('L')
            img1_3 = Image.open(os.path.join(path, pic_name1_3)).convert('L')
            img2 = Image.open(os.path.join(path, pic_name2)).convert('L')
            label = Image.open(os.path.join(path, label_name)).convert('L')
            multi_mode_imgs.append(img1_1)
            multi_mode_imgs.append(img2)
